...
printf '%*s\n' "${COLUMNS:-$(tput cols)}" '' | tr ' ' -
# Displays a divider large as the Terminal window
echo -e "${G}Conversion to ORIGINAL 768x512 completed in $(($duration / 60))min and $(($duration % 60))s.${N}"
